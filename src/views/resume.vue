<template>
  <div class="resume">
    <div class="banner">
      ...
      <div v-if="person.birth" class="banner__location">Nascido em {{person.birth.year}} em {{person.birth.location}}</div>
    </div>
    ...
    <div class="content">
      ...
      <div class="content__right">
        <div class="section">
          <div class="section-headline">
            <i class="section-headline__icon material-icons">work</i>Experiência Profissional
          </div>
        ...
        <div class="section">
          <div class="section-headline">
            <i class="section-headline__icon material-icons">school</i>Formação Acadêmica
          </div>
        ...
        <div
          ...
          class="section">
          <div class="section-headline">
            <i class="section-headline__icon material-icons">code</i>Projetos
          </div>
        ...
        <div
          ...
          class="section">
          <div class="section-headline">
            <i class="section-headline__icon fa fa-heart"></i>Contribuições
          </div>
...
.picture {
  ...
  left: @left-column-width - @picture-size / 2 + 10;
  height: @picture-size;
  width: @picture-size;
  border-radius: 50%;
...
.content {
  ...
  &__right {
    flex: 1;
    max-width: calc((100% - @left-column-width) - @base-padding * 2);
